...
def sg1_mesh(
    ...
    angular Lebedev-Laikov mesh. The resulting mesh is partitioned following the scheme
    introduced by Becke [2]_ to reweight each point based on their proximity to
    ...
    # For each atom-centered grid, evaluate the distance from each mesh point to all
    # unique pairs of atoms
    ...
    # pairwise distances between atom centers
